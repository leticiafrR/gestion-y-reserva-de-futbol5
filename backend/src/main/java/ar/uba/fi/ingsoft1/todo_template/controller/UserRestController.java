...
public class UserRestController {
    ...
    public ResponseEntity<TokenDTO> login(
            @Parameter(description = "Encabezado de autorización básica con base64(email:contraseña)")
    ...
    public ResponseEntity<Void> logout(
            @Parameter(description = "Token de actualización a invalidar")
    ...
    public ResponseEntity<TokenDTO> refreshToken(
            @Parameter(description = "Token de actualización")
            @RequestBody TokenDTO token) {
        // Implementación dummy
    ...
    public ResponseEntity<TokenDTO> register(
            ...
            @Valid @RequestBody UserProfileDTO userData) {
        // Implementación dummy
    ...
    public ResponseEntity<PaginatedResponse<UserSearchResultDTO>> searchUsers(
        ...
        // Implementación dummy
        var results = List.of(
                new UserSearchResultDTO("usuario1", "Juan", "Pérez", "https://ejemplo.com/1.jpg", "masculino"),
                new UserSearchResultDTO("usuario2", "María", "González", "https://ejemplo.com/2.jpg", "femenino")
        );
    ...
    public ResponseEntity<Void> sendFollowRequest(
            @Parameter(description = "ID del usuario objetivo")
