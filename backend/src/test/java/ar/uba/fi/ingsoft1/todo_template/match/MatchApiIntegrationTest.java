...
public class MatchApiIntegrationTest extends BaseIntegrationTest {
    ...
    public void setupEntities() {
        ...
        UserCreateDTO userDto = new UserCreateDTO(
            "Nombre", "Apellido", "match@test.com", "123456", "USER", "male", "1990", "Ciudad", "url"
        );
        ResponseEntity<TokenDTO> register = restTemplate.postForEntity(buildUrl("/users/register"), userDto, TokenDTO.class);
        ...
        Booking savedBooking = getBean(ar.uba.fi.ingsoft1.todo_template.booking.BookingRepository.class).save(booking);
    ...
    public void shouldCreateOpenMatchSuccessfully() {
        ...
        ResponseEntity<String> response = restTemplate.exchange(buildUrl("/matches/open"), HttpMethod.POST, request, String.class);
    ...
    public void shouldCreateCloseMatchSuccessfully() {
        ...
        ResponseEntity<String> response = restTemplate.exchange(buildUrl("/matches/close"), HttpMethod.POST, request, String.class);
