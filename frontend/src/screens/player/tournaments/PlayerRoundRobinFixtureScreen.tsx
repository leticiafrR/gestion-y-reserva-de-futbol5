...
interface PlayerRoundRobinFixtureScreenProps {
  tournament: Tournament
}

type TabType = "matches" | "standings" | "statistics"

export const PlayerRoundRobinFixtureScreen = ({ tournament }: PlayerRoundRobinFixtureScreenProps) => {
                  ...
                  <table style={{ width: "100%", borderCollapse: "collapse" }}>
                    ...
                    <tbody>
                      {standings.map((standing, index) => (
                        <tr key={standing.id.teamId} style={{ backgroundColor: index < 3 ? "var(--background)" : "transparent", borderBottom: "1px solid var(--border)" }}>
